...
```{r}
sub.assigned.genes2celltype.df = assigned.genes2celltype.df[match(Xd$Labels[1:97], assigned.genes2celltype.df$gene), ]
write.table(sub.assigned.genes2celltype.df, "~/results/figures/PGC3/SNP_to_gene_assignments_sig.tsv", sep = "\t", row.names = F, col.names = T, quote = F)
