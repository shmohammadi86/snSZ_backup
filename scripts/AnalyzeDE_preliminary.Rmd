...
pdf(file.path(figures.path, "selected_DE_genes_splitted_v2.pdf"), height = 18)
...
pdf(file.path(figures.path, "selected_DE_genes_splitted_matched_bulk_v2.pdf"), width = 1.8, height = 16)
